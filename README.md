...
个人 AI 工具与 Skill 集合。每个工具保留独立入口、代码和使用说明，便于复制、维护和在不同项目中复用。
...
具体课程、汇报文稿等放在仓库之外的独立项目目录。新增工具可在 skills 下创建自己的文件夹，并在上面的工具目录登记。

## html-slides 快速开始

需要 Node.js 18 或更新版本。首次安装依赖需要联网，此后默认可离线编译与展示。在仓库根目录运行：
